                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="radio" name="status" id="status-yes" value="1" class="am-radio-inline"> 发布
                                            <input type="radio" name="status" id="status-no" value="-1" checked class="am-radio-inline"> 草稿
                                        </div>
                                    </div>
